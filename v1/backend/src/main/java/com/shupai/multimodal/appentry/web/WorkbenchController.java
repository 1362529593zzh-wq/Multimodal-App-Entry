...
public class WorkbenchController {
    ...
    @PostMapping("/tasks/{taskId}/ppt/generate-file")
    public Map<String, Object> generatePptFile(
            @PathVariable String taskId,
            @Valid @RequestBody PptGenerateRequest request
    ) {
        return workbenchService.generatePptFile(taskId, request);
    }
